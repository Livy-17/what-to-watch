      ...
      <div>
        ...
        <Slider {...settings}>
          {dataFiltered.map((item, i) => {
            return (
              <div key={i} id='sub--container' className="border-solid border-2">
                <div className="z-20 absolute top-[45%] hover:cursor-pointer hidden h-[40px] w-[100%] border-solid boder-red-300 border-2" id='sub--button' onClick={() => handleModalOpen(i)}>
